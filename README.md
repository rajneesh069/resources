...
- For more content on CP, use YouTube.
...
0. Learn [JavaScript](https://youtube.com/playlist?list=PLu71SKxNbfoBuX3f4EOACle2y-tRC5Q37&si=y_GgrNTRUg3-5bKf)
...
4. Learn [Next.js](https://nextjs.org/learn) + Tailwind CSS
...
5. Understand what are [Server Components](https://youtu.be/VIwWgV3Lc6s?si=D48qZjwv6lvHNppD) and how to use them
6. Learn [Prisma ORM](https://www.prisma.io/) and a SQL database(PostgreSQL recommended - [Neon](https://neon.tech/) for remote hosting)
   - [Video 1](https://youtu.be/QXxy8Uv1LnQ?si=8AyGxRlDi1jzf83A)
   - [Video 2](https://youtu.be/RebA5J-rlwg?si=DubInABLgjQPpoPW)
7. Learn how to use a UI library (Recommended: [ShadCN/UI](https://ui.shadcn.com/docs))
8. Learn how to use an Auth library with Next.js (Recommended: NextAuth also known as Auth.js and then move to Clerk.js)
...
9. Learn [tRPC router](https://youtu.be/S6rcrkbsDI0?si=fweD-EBEqj6jGqqt)
   - [tRPC by Web Dev Simplified](https://youtu.be/UfUbBWIFdJs?si=EwZOMKHofF-azdFC)
10. Understand and start using the [T3 Stack](https://create.t3.gg/)
...
14. Learn how to deploy(using [GitHub Workflows and CI/CD](https://youtu.be/icZUzgtz_d8?si=wJqyD5R7MsB-ZC9L)) the container on an Amazon EC2 instance, and then how to manage certificates using certbot
    - [CI/CD Project](https://youtu.be/NnkUGzaqqOc?si=K6JCpb_qth-lmNk_)
15. Learn why we need a [Reverse Proxy](https://youtu.be/zmrhxrYxonE?si=uDihswg_vLioZVjX) like `nginx` and how to integrate it on the server side
16. Learn [WebSockets](https://youtu.be/7WQ2EbXLfLI?si=4L7CqJAoC9A5qAHy), [Long Polling](https://youtu.be/_CCyMWSZNU4?si=0EHYk2ttohLAXld8) and [Server Sent Events](https://youtu.be/_CCyMWSZNU4?si=0EHYk2ttohLAXld8)
    - [**NOT** Just Another Chat App](https://www.youtube.com/watch?v=pfZT6Opgy4o)
17. Optional: Kubernetes for management of multiple Docker containers
...
6. Learn asynchronous programming in Python
   - [Video](https://youtu.be/Qb9s3UiMSTA)
7. Learn [NumPy](https://youtu.be/x7ULDYs4X84?si=1E73RqFFdauL1q4Q) for Python
8. Learn [Pandas](https://youtu.be/EhYC02PD_gc?si=lsrgETgMLWL3wLHW)
9. Optional: Learn [Django](https://youtube.com/playlist?list=PLu71SKxNbfoDOf-6vAcKmazT92uLnWAgy&si=6rhPI6l9A4QHecwh)
